...
public class WebDriverManager {
	...
	private void loadConfigFromSystemProperty() {
	...
	private void loadConfigFromPropertyFile() {
		if(null== PropertyHolder.webdriverConfig)
		{
			System.out.println("!!!!!! Webdriver Object Creation failed. WebDriverConfig.properties does not load properly");
			System.exit(-1);
		}
		...
		{
			System.out.println("!!!!!! DRIVER property from WebDriverConfig.properties should be either REMOTE or BROWSER.");
			System.exit(-1);
		}
